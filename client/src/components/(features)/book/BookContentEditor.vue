...
const editor = useEditor({
    ...
    editorProps: {
        attributes: {
            spellcheck: "true",
            class: "prose max-w-none text-grey-700 prose-sm  min-h-80  max-h-[800px] overflow-y-auto focus:outline-none p-4 overflow-y-auto scrollbar-thin scrollbar-thumb-slate-300 scrollbar-track-slate-100 scrollbar-thumb-rounded-full"
        },

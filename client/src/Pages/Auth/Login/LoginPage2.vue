...
<template>
    ...
    <div
        class="container relative xl:h-screen h-[800px] flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0">
        ...
        <div
            class="relative h-60 rounded-sm sm:rounded-none lg:h-full flex-col bg-muted p-10 text-white dark:border-r lg:flex">

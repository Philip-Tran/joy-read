<template>
    <div :class="cn(
        ...
        ">
        <div :style="{ width: sizeMap[size].width, transition: `transform ${props.duration}ms ease` }" :class="[
          ...
          `" :style="{
            ...
            boxShadow: '5px 5px 20px var(--shadowColor)',
                ...
                <div class="absolute left-0 top-0 h-full" :style="{
                    minWidth: '8.2%',
                    background:
            ...
            <div class="absolute left-0 bg-white" :style="{
                top: '3px',
                bottom: '3px',
                width: '48px',
